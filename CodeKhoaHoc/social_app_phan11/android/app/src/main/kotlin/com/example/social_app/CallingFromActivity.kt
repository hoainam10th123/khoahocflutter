...
import com.example.social_app.api.AgoraService
import com.example.social_app.databinding.ActivityCallingfromBinding
...
import com.example.social_app.widget.MovieView
...
class CallingFromActivity: AppCompatActivity(), LifecycleObserver {
    ...
    private fun setupVideoSDKEngine() {
        try {
            ...
            val call: Call<ResToken> = service.getRtcToken(Settings(Constanst.currentUsername, SignalRService.channelName))
    ...
    fun joinChannel(token: String, channelName: String) {
        if (checkSelfPermission()) {
            ...
            agoraEngine!!.joinChannelWithUserAccount(token, channelName, Constanst.currentUsername, options)
        } else {
